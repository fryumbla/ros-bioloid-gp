...
void joint_callback(const sensor_msgs::JointState& data)
{
  ...
  simxSetJointTargetPosition(clientID, (simxInt) joint_9_handle, data.position.at(8), simx_opmode_oneshot);
  simxSetJointTargetPosition(clientID, (simxInt) joint_10_handle, data.position.at(9), simx_opmode_oneshot);
  simxSetJointTargetPosition(clientID, (simxInt) joint_11_handle, data.position.at(10), simx_opmode_oneshot);
  simxSetJointTargetPosition(clientID, (simxInt) joint_12_handle, data.position.at(11), simx_opmode_oneshot);
  simxSetJointTargetPosition(clientID, (simxInt) joint_13_handle, data.position.at(12), simx_opmode_oneshot);
  simxSetJointTargetPosition(clientID, (simxInt) joint_14_handle, data.position.at(13), simx_opmode_oneshot);
  simxSetJointTargetPosition(clientID, (simxInt) joint_15_handle, data.position.at(14), simx_opmode_oneshot);
  simxSetJointTargetPosition(clientID, (simxInt) joint_16_handle, data.position.at(15), simx_opmode_oneshot);
  simxSetJointTargetPosition(clientID, (simxInt) joint_17_handle, data.position.at(16), simx_opmode_oneshot);
  simxSetJointTargetPosition(clientID, (simxInt) joint_18_handle, data.position.at(17), simx_opmode_oneshot);
  simxSetJointTargetPosition(clientID, (simxInt) joint_19_handle, data.position.at(18), simx_opmode_oneshot);
