...
class EX(genpy.Message):
  _md5sum = "49929b8e4c95abff8543ee349bf2dc0b"
  _type = "dynamixel_workbench_msgs/EX"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """# This message is compatible with control table of Dynamixel EX Series (EX-106+)
...
"""
  __slots__ = ['Model_Number','Firmware_Version','ID','Baud_Rate','Return_Delay_Time','CW_Angle_Limit','CCW_Angle_Limit','Drive_Mode','Temperature_Limit','Min_Voltage_Limit','Max_Voltage_Limit','Max_Torque','Status_Return_Level','Alarm_LED','Shutdown','Torque_Enable','LED','CW_Compliance_Margin','CCW_Compliance_Margin','CW_Compliance_Slope','CCW_Compliance_Slope','Goal_Position','Moving_Speed','Torque_Limit','Present_Position','Present_Speed','Present_Load','Present_Voltage','Present_Temperature','Registered','Moving','Lock','Punch','Sensored_Current']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       Model_Number,Firmware_Version,ID,Baud_Rate,Return_Delay_Time,CW_Angle_Limit,CCW_Angle_Limit,Drive_Mode,Temperature_Limit,Min_Voltage_Limit,Max_Voltage_Limit,Max_Torque,Status_Return_Level,Alarm_LED,Shutdown,Torque_Enable,LED,CW_Compliance_Margin,CCW_Compliance_Margin,CW_Compliance_Slope,CCW_Compliance_Slope,Goal_Position,Moving_Speed,Torque_Limit,Present_Position,Present_Speed,Present_Load,Present_Voltage,Present_Temperature,Registered,Moving,Lock,Punch,Sensored_Current
    ...
    if args or kwds:
      ...
      if self.Punch is None:
        self.Punch = 0
      if self.Sensored_Current is None:
        self.Sensored_Current = 0
    else:
      self.Model_Number = 0
      self.Firmware_Version = 0
      self.ID = 0
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_H4B2H4BH9B6H5B2H().pack(_x.Model_Number, _x.Firmware_Version, _x.ID, _x.Baud_Rate, _x.Return_Delay_Time, _x.CW_Angle_Limit, _x.CCW_Angle_Limit, _x.Drive_Mode, _x.Temperature_Limit, _x.Min_Voltage_Limit, _x.Max_Voltage_Limit, _x.Max_Torque, _x.Status_Return_Level, _x.Alarm_LED, _x.Shutdown, _x.Torque_Enable, _x.LED, _x.CW_Compliance_Margin, _x.CCW_Compliance_Margin, _x.CW_Compliance_Slope, _x.CCW_Compliance_Slope, _x.Goal_Position, _x.Moving_Speed, _x.Torque_Limit, _x.Present_Position, _x.Present_Speed, _x.Present_Load, _x.Present_Voltage, _x.Present_Temperature, _x.Registered, _x.Moving, _x.Lock, _x.Punch, _x.Sensored_Current))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.Model_Number, _x.Firmware_Version, _x.ID, _x.Baud_Rate, _x.Return_Delay_Time, _x.CW_Angle_Limit, _x.CCW_Angle_Limit, _x.Drive_Mode, _x.Temperature_Limit, _x.Min_Voltage_Limit, _x.Max_Voltage_Limit, _x.Max_Torque, _x.Status_Return_Level, _x.Alarm_LED, _x.Shutdown, _x.Torque_Enable, _x.LED, _x.CW_Compliance_Margin, _x.CCW_Compliance_Margin, _x.CW_Compliance_Slope, _x.CCW_Compliance_Slope, _x.Goal_Position, _x.Moving_Speed, _x.Torque_Limit, _x.Present_Position, _x.Present_Speed, _x.Present_Load, _x.Present_Voltage, _x.Present_Temperature, _x.Registered, _x.Moving, _x.Lock, _x.Punch, _x.Sensored_Current,) = _get_struct_H4B2H4BH9B6H5B2H().unpack(str[start:end])
      return self
