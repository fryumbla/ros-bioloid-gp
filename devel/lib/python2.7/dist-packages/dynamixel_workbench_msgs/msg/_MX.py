...
class MX(genpy.Message):
  _md5sum = "f2b95d725db95aec0be4e30a981f545e"
  _type = "dynamixel_workbench_msgs/MX"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """# This message is compatible with control table of Dynamixel MX Series (MX-12W, MX-28T/MX-28R/MX-28AT/MX-28AR)
...
"""
  __slots__ = ['Model_Number','Firmware_Version','ID','Baud_Rate','Return_Delay_Time','CW_Angle_Limit','CCW_Angle_Limit','Temperature_Limit','Min_Voltage_Limit','Max_Voltage_Limit','Max_Torque','Status_Return_Level','Alarm_LED','Shutdown','Multi_Turn_Offset','Resolution_Divider','Torque_Enable','LED','D_gain','I_gain','P_gain','Goal_Position','Moving_Speed','Torque_Limit','Present_Position','Present_Speed','Present_Load','Present_Voltage','Present_Temperature','Registered','Moving','Lock','Punch','Goal_Acceleration']
  _slot_types = ['uint16','uint8','uint8','uint8','uint8','uint16','uint16','uint8','uint8','uint8','uint16','uint8','uint8','uint8','uint16','uint8','uint8','uint8','uint8','uint8','uint8','uint16','uint16','uint16','uint16','uint16','uint16','uint8','uint8','uint8','uint8','uint8','uint16','uint8']
...
def _get_struct_I():
    global _struct_I
    return _struct_I
_struct_H4B2H3BH3BH6B6H5BHB = None
def _get_struct_H4B2H3BH3BH6B6H5BHB():
    global _struct_H4B2H3BH3BH6B6H5BHB
    if _struct_H4B2H3BH3BH6B6H5BHB is None:
        _struct_H4B2H3BH3BH6B6H5BHB = struct.Struct("<H4B2H3BH3BH6B6H5BHB")
    return _struct_H4B2H3BH3BH6B6H5BHB
