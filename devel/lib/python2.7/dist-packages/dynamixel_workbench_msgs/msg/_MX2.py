...
"""autogenerated by genpy from dynamixel_workbench_msgs/MX2.msg. Do not edit."""
import sys
...
class MX2(genpy.Message):
  _md5sum = "ea49a2701ed85afc888c2c84aca6af1f"
  _type = "dynamixel_workbench_msgs/MX2"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """# This message is compatible with control table of Dynamixel MX(2.0) Series (MX-12W(2.0), MX-28T/MX-28R/MX-28AT/MX-28AR(2.0))
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MX2, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.Model_Number, _x.Firmware_Version, _x.ID, _x.Baud_Rate, _x.Return_Delay_Time, _x.Drive_Mode, _x.Operating_Mode, _x.Secondary_ID, _x.Protocol_Version, _x.Homing_Offset, _x.Moving_Threshold, _x.Temperature_Limit, _x.Max_Voltage_Limit, _x.Min_Voltage_Limit, _x.PWM_Limit, _x.Acceleration_Limit, _x.Velocity_Limit, _x.Max_Position_Limit, _x.Min_Position_Limit, _x.Shutdown, _x.Torque_Enable, _x.LED, _x.Status_Return_Level, _x.Registered_Instruction, _x.Hardware_Error_Status, _x.Velocity_I_Gain, _x.Velocity_P_Gain, _x.Position_D_Gain, _x.Position_I_Gain, _x.Position_P_Gain, _x.Feedforward_2nd_Gain, _x.Feedforward_1st_Gain, _x.Bus_Watchdog, _x.Goal_PWM, _x.Goal_Velocity, _x.Profile_Acceleration, _x.Profile_Velocity, _x.Goal_Position, _x.Realtime_Tick, _x.Moving, _x.Moving_Status, _x.Present_PWM, _x.Present_Load, _x.Present_Velocity, _x.Present_Position, _x.Velocity_Trajectory, _x.Position_Trajectory, _x.Present_Input_Voltage, _x.Present_Temperature,) = _get_struct_H8BiIB3H4I6B7HBhi3IH2B2h2i2IHB().unpack(str[start:end])
      return self
...
def _get_struct_I():
    global _struct_I
    return _struct_I
_struct_H8BiIB3H4I6B7HBhi3IH2B2h2i2IHB = None
def _get_struct_H8BiIB3H4I6B7HBhi3IH2B2h2i2IHB():
    global _struct_H8BiIB3H4I6B7HBhi3IH2B2h2i2IHB
    if _struct_H8BiIB3H4I6B7HBhi3IH2B2h2i2IHB is None:
        _struct_H8BiIB3H4I6B7HBhi3IH2B2h2i2IHB = struct.Struct("<H8BiIB3H4I6B7HBhi3IH2B2h2i2IHB")
    return _struct_H8BiIB3H4I6B7HBhi3IH2B2h2i2IHB
