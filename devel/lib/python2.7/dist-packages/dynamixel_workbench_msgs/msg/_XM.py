...
"""autogenerated by genpy from dynamixel_workbench_msgs/XM.msg. Do not edit."""
import sys
...
class XM(genpy.Message):
  _md5sum = "625146aaba5730bf1ea1a9008887b10d"
  _type = "dynamixel_workbench_msgs/XM"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """# This message is compatible with control table of Dynamixel XM Series (XM430-W210, XM430-W350)
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(XM, self).__init__(*args, **kwds)
...
def _get_struct_I():
    global _struct_I
    return _struct_I
_struct_H8BiIB4H4I6B7HB2hi3IH2B3h2i2IHB = None
def _get_struct_H8BiIB4H4I6B7HB2hi3IH2B3h2i2IHB():
    global _struct_H8BiIB4H4I6B7HB2hi3IH2B3h2i2IHB
    if _struct_H8BiIB4H4I6B7HB2hi3IH2B3h2i2IHB is None:
        _struct_H8BiIB4H4I6B7HB2hi3IH2B3h2i2IHB = struct.Struct("<H8BiIB4H4I6B7HB2hi3IH2B3h2i2IHB")
    return _struct_H8BiIB4H4I6B7HB2hi3IH2B3h2i2IHB
