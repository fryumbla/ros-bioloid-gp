...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'bioloidgp_social_robot' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/francisco/robotis_ws/src/ros-bioloid-gp/src/bioloid_gp_description/bioloidgp_social_robot/${idir}'.  ${_report}")
    endif()
